...
from lattice.symmetry.two_particle import two_particle_operator_Cartesian_basis

print("S-wave, PV type opetator with mom=2")
for i in two_particle_operator_Cartesian_basis(
    op1="V",
    op2="P",
    J=1,
    L=0,
...
# TODO:add API for Opetator class