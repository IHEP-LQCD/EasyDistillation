...
from lattice.correlator.one_particle import twopoint_isoscalar
...
insertionField = Insertion(GammaName.PI_2, DerivativeName.IDEN, ProjectionName.A1, momDict_mom9)
